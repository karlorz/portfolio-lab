...
class DashboardGenerator(_EnsembleSectionsMixin, _HedgeSectionsMixin, _RegimeAuthorityMixin, _AlertsSectionsMixin, _OverlaySectionsMixin, _StackingSectionsMixin):

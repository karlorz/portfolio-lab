...
SIGNAL_SOURCE_META = {
    ...
    "international_momentum": {"name": "International Momentum", "category": "trend"},
    "alternative_data": {"name": "Alternative Data", "category": "fundamental"},
    "cross_asset_regime_arb": {"name": "Cross-Asset Regime Arb", "category": "regime"},

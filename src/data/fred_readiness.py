...
# Explicit logger name (not __name__): caplog pins in tests/test_fred_readiness.py
# assert logger="src.monitor.fred_readiness" — keep stable across relocation.
logger = logging.getLogger("src.monitor.fred_readiness")

...
class BondMomentumOverlayBacktester:
    ...
    def run_backtest(self) -> BacktestResult:
        ...
        # Use shared compute_metrics on equity values
        eq_values = [config.initial_capital] + [e['equity'] for e in equity_curve]
        metrics = compute_metrics(eq_values, config.initial_capital)
        ...
        sharpe_improvement = metrics.sharpe_ratio - baseline_sharpe

...
- 109 test files covering signals, strategy, dashboard, broker, agents, data, research, monitor
- Run: `uv run pytest tests/` (full suite), `uv run pytest tests/ -m heavy` (ML tests, needs PORTFOLIO_LAB_ENABLE_ML=1)

### TypeScript (tests/ts/)
- **159 tests** across 8 files (DSR 24, duration-signals 35, purged-cv 21, car25 23, stress-validation 15, sector-attribution 19, sector-momentum 15, leveraged-treasury 7)
- Run: `bun test tests/ts/`
- Bun native test runner, zero configuration needed
- Key modules: test_options_utils (78), test_strategy_comparison (71), test_duration_allocation (63), test_network_momentum_leadlag (62), test_cta_overlay (59), test_sentiment_analyzer (56), test_base_agent (54), test_regime_sentiment (53), test_alt_data_walkforward_stress (52), test_odte_yield (52), test_arp_overlay (51), test_correlation_regime_detector (51), test_odte_overlay (50), test_regime_ml_validation (50), test_vol_targeting (50), test_tail_hedge (49), test_tsmom_overlay (46), test_tail_hedge_calculator (46), test_earnings_analyzer (45), test_institutional_crypto (45), test_garch_cvar (45), test_fed_analyzer (44), test_duration_yield_backtest (44), test_behavioral_sentiment (43), test_execution_agent (43), test_vix_position_manager (39), test_esg_integration (38), test_regime_ml (38), test_circuit_breaker (38), test_entropy_monitor (38), test_defi_yield_fetcher (37), test_trend_integration (36), test_multi_speed_momentum (36), test_macro_momentum (36), test_marl_trainer (36), test_fed_policy_overlay (35), test_market_calendar (35), test_generator (35), test_alternative_data_backfill (35), test_yield_curve_regime (35), test_risk_parity_overlay (34), test_integrator (34), test_credit_fetcher (34), test_alpaca (33), test_cta_backtest (33), test_vix_options_chain (33), test_cvar_metrics (32), test_network_momentum (32), test_dual_momentum (32), test_run_actual_ubt_validation (32), test_quantum_hybrid (32), test_evaluator (31), test_signal_health_monitor (31), test_commodity_curve (31), test_regime_hmm (30), test_sentiment_client (30), test_sector_momentum_calc (30), test_ensemble_voter (29), test_factor_rotation (29), test_notifier (29), test_vix_insurance_signal (29), test_crypto_correlation_monitor (28), test_factor_timing_backtest (28), test_combined_orchestrator (27), test_inflation_risk_parity (26), test_risk_agent_hmm (26), test_macro_features (26), test_etf_premium_display (26), test_reddit_sentiment_fetcher (26), test_stacking_integrator (26), test_combined_strategy (25), test_credit_spread (25), test_health_monitor (25), test_international_momentum (25), test_rebalancing_backtest (25), test_risk_parity_weight_overlay (25), test_convexity_harvest (24), test_credit_spread_signal (24), test_vix_ensemble_adapter (24), test_factor_data_fetcher (24), test_mock_quality_scores (24), test_vpin_bvc (24), test_closing_auction_signal (23), test_vol_parity_allocator (22), test_alternative_data (22), test_ensemble_backtest (22), test_duration_overlay (22), test_signal_execution_bridge (21), test_factor_timing_pipeline (21), test_odte_broker_integration (21), test_stacking_feature_engine (20), test_liquidity_checks (18), test_signal_health_tracker (18), test_fx_carry_ml (18), test_factor_data (17), test_stacking_trainer (17), test_defi_dashboard (16), test_multi_strategy_adapters (15), test_tsmom_integration (15), test_closing_auction_fetcher (14), test_order_router (32), test_rebalance_scheduler (14), test_vpin_rebalancer (13), test_health_backfill (12), test_tips_monitor (11), test_position_sync (29)

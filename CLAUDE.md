...
|- **Health report helpers**: `src/dashboard/health_report.py` — freshness classification, `derive_system_status`, symbol freshness rows (`test_health_report.py`); used by `generate_health_json()`

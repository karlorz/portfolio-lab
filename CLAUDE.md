...
- Test count: **4051 safe** (0 failures, 5 skipped)
...
- **Python**: 4051 safe (0 failures, 5 skipped), 117 test files
...
## Quick Start
```bash
make test            # safe test suite (ML disabled, 3GB cap, 4051 passing)

...
- Test count: **3863 safe** (0 failures, 5 skipped)
...
- **Python**: 3863 safe (0 failures, 5 skipped), 110 test files
...
## Quick Start
```bash
make test            # safe test suite (ML disabled, 3GB cap, 3863 passing)

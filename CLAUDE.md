...
|- **Broker data loader**: `src/dashboard/broker_data_loader.py` — `BrokerDataLoader` extracted from `DashboardGenerator._load_broker_data()` for isolated tests (`test_broker_data_loader.py`)
